# RuleMemory Terminal Capture Bundle

> Cached bundle from a verified live run on 2026-06-07. Workspace host is a
> sanitized placeholder. Regenerate with `./scripts/capture_demo_bundle.sh`
> after exporting your own `QWEN_API_KEY` and `QWEN_OPENAI_BASE_URL`.

- generated_at: 2026-06-07 01:47:00 KST
- package: RuleMemory
- track: MemoryAgent
- capture_status: ready

## Screen 1: Secret-Safe Setup

```bash
export QWEN_API_KEY="<redacted>"
export QWEN_OPENAI_BASE_URL="https://<workspace-host>/compatible-mode/v1"
```

## Screen 2: Qwen-Backed RuleMemory Demo

```bash
./scripts/qwen_rule_memory_demo.sh
```

- generated_trace: docs/qwen_rule_memory_demo_trace.md
...
## Screen 3: Alibaba/Qwen Cloud Code-File Proof
...
```json
{
  ...
  "base_url": "https://your-workspace-id.ap-southeast-1.maas.aliyuncs.com/compatible-mode/v1",
  "model": "qwen-plus",
  "seed_path": "docs/rule_memory_live_seed_20260607.json",
  "http_status": 200,
  "secret_written": false,
  "assistant_preview": "{\n  \"remembered_facts\": [\n    \"Qwen Cloud Hackathon submission deadline is 2026-07-09 14:00 PT, with an internal KST freeze target before 2026-07-08.\",\n    \"RuleMemory targets the MemoryAgent track to persist contest rules, preferences, stale assumptions, and source provenance across sessions.\",\n    \"The workspace MaaS OpenAI-compatible endpoint (https://your-workspace-id.ap-southeast-1.maas.aliyuncs.com/compatible-mode/v1/models) is verified and active; the DashScope endpoint is invalid for t"
}

```

## Screen 4: Submission Package Status
...
- [ ] Devpost form answers and track selection
...
- Keep the final video under about 3 minutes.
- Use this bundle as the terminal script for the recording.
